        ...
        return (
            <Toggle title={"JavaScripts Base List"}>
                <Toggle size={2} title="var const let">
                    ...
                    <p>
                        Không thể gán lại giá trị(re-assign). Tuy nhiên với
                        array hoặc object const chỉ không cho phép thay đổi địa
                        chỉ trỏ tới ví dụ như không thẻ gán const array/object
                        cho một array/object khác nhưng có thể chỉnh sửa bên
                        trong array/object như thêm, sửa giá trị, thuộc tính.
                    </p>
                ...
                <Toggle title="Toan tu" size={2}>
                    <p>- So sanh: == ===</p>
                    <p>
                        - Logic: && || ??(trả về vế phải nếu vế trái
                        null/undefined vd null ?? 5)
                    </p>
                    <p>- 3 Ngôi: (...) ? ... : ...</p>
                </Toggle>
                <Toggle title="Dieu kien" size={2}>
                    ...
                    <Toggle title="for" size={3}>
                        ...
                        <p>
                            - <span className="font-bold">for/in:</span> dùng để
                            lặp qua key của đối tượng. Không nên dùng cho array
                            hay string do không đảm bảo thứ tự, index là chuỗi,
                            dễ lẫn thuộc tính, khó xử lý unicode trong string
                        </p>
                        <p>
                            EX: const myInfo = {"{"} name: "Binh dep trai", age:
                            18 {"}"}
                        </p>
                        <p>for (let key in myInfo) {"{}"}</p>
                        <p>
                            <span className="font-bold">- for of:</span> Dùng để
                            duyệt qua giá trị iterable (array, string, map, set
                            NodeList)
                        </p>
                    </Toggle>
                </Toggle>
                <Toggle title="function" size={2}>
                    <strong>
                        Function gồm: declaration, expression, arrow function
                    </strong>
                    <p>
                        <span className="font-bold">
                            - Declaration Function:{" "}
                        </span>
                        ex: function DeFun() {"{}"} - Có hosting, có thể gọi
                        trước khi khai báo
                    </p>
                    <p>
                        <span className="font-bold">
                    ...
                    <p>
                        <span className="font-bold">- Arrow Function: </span>ex:
                        const arrowFun = () ={">"} {"{}"} - Có thể bỏ dấu () và{" "}
                        {"{}"} nếu có ít tham số và kết quả ngắn gọn
                    </p>
                    <Toggle title="Tham so" size={3}>
                        ...
                        <p>
                            rest parameters gom nhóm các tham số còn lại thành 1
                            mảng (có thể dùng array method như map, reducer)
                        </p>
                        <code>function nameFunction(name, ...info)</code>
                        <p>
                            Lưu ý: Chỉ có 1 rest parameters và phải đứng sau
                            cùng.
                        </p>
                    </Toggle>
                </Toggle>
                ...
                <Toggle title="Object" size={2}>
                    <p>
                        <strong>- Tao object:</strong> {"{}"}, new Object(),
                        class, constructor, Object.create
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        obj.name/obj["name"] = "Mike" (Neu key chua co - tao
                        moi; Neu key da ton tai - cap nhap)
                    </p>
                    <p>
                ...
                <Toggle title="Array" size={2}>
                    <Toggle title="Array method" size={3}>
                        <p>
                            <strong>
                                - Array method: filter, find, some, every, map,
                                reduce
                            </strong>
                        </p>
                        <p>
                        ...
                        <p>
                            <strong>- find() -</strong> Trả về giá trị đầu tiên
                            thỏa điều kiện
                        </p>
                        <p>
                            <strong>- some() -</strong> Trong 1 mảng ví dụ tag =
                            ['AAA', 'BBB', 'CCC'] student.tags.some(tag ={">"}{" "}
                            tag === 'BBB') nếu đúng return true, ngược lại false
                        </p>
                        <p>
                            <strong>- every() -</strong> Trong 1 mảng ví dụ tag
                            = ['AAA', 'BBB', 'CCC'] student.tags.some(tag ={">"}{" "}
                            tag === 'BBB') nếu tất cả mảng là 'BBB' return true,
                            ngược lại false
                        </p>
                        <p>
                            <strong>- map() -</strong> Tạo ra và trả về 1 mảng
                            mới.
                        </p>
                        <p>
                            <strong>- reduce() -</strong> Nhận 2 tham số là
                            callback và constructor. Callback nhận 4 giá trị:
                            accumlate (tích lũy), 3 tham số như các callback của
                            các hàm khác. Constructor là giá trị khởi tạo ban
                            đầu của accumlate reducer(callback, constructor)
                        </p>
                        <p>
                            <strong>vd Tính tổng:</strong> array.reduce((acc,
                            curr) ={">"} acc + curr, 0)
                        </p>
                    </Toggle>
                    <Toggle title="Thao tác với mảng" size={3}>
                        ...
                        <p>
                            <strong>- slice(start, end):</strong> copy 1 phần
                            mảng // {"["}
                            start, end)
                        </p>
                        <p>
                            <strong>- splice(index, xóa, chèn):</strong>{" "}
                            splice(1, 2, 99, 100) // tại index 1 xóa 2 phần tử
                            thêm 99 100 ([1, 2, 3, 4] -{">"} [1, 99, 100, 4])
                        </p>
                    </Toggle>
                </Toggle>
                <Toggle title="destructuring & spread" size={2}>
                    <p>
                        <strong>- Destructuring:</strong> trích xuất giá trị từ
                        array/object và gán chúng vào các biến riêng lẻ
                    </p>
                    <p>
                        <strong>- Spread:</strong> trải phẳng - copy 1
                        array/object để tạo thành array/object mới
                    </p>
                    <p>
                        <strong>- Ex:</strong>cho arr = [1, 2, 3] newArr = [arr,
                        4] sẽ tạo ra array mới với newArr[0] = arr còn newArr[1]
                        = 4. newArr = [...arr, 4] sẽ tạo ra newArr với 4 phần tử
                        là 1, 2, 3, 4
                    </p>
                    <Toggle title="Bài tập destructuring & spread" size={3}>
                        ...
                        <ol>
                            <li>
                                Dùng destructuring để gán 10 vào biến a và 20
                                vào biến b.
                            </li>
                            <li>
                                Dùng destructuring để lấy phần tử đầu tiên vào
                                first, còn lại vào rest.
                            </li>
                            <li>
                                Dùng spread để tạo một mảng mới copy từ numbers.
                            </li>
                            <li>
                                Dùng spread để tạo một mảng mới có thêm số 60
                                vào cuối.
                            </li>
                            <li>
                                Dùng spread để tạo một mảng mới có thêm số 5 vào
                                đầu.
                            </li>
                            <li>
                                Dùng destructuring để bỏ qua 20 và lấy 10 và 30.
                            </li>
                        </ol>
                    </Toggle>
                </Toggle>
